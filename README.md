...
| FOLDER TITLE  | DESCRIPTION |
| ------------- | ------------- |
|  1_Requirements | intoroduction and features by Anant,requiremnets by Sakshi(helped by darshan s),SWOT analysis by Darshan k ,5w and 1h by Darshan s,Features by Harshitha N |
|  2_Design   |  All block diagram and flowcharts  Harshitha N and Sakshi(pindiagram and discription.)|
